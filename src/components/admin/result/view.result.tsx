import { callUpdateResult } from "@/config/api";
...
interface IProps {
    ...
    open: boolean;
    dataInit: IResult | null | any;
    setDataInit: (v: any) => void;
    reloadTable: () => void;
}
const ViewDetailResult = (props: IProps) => {
    ...
    //     const res = await callUpdateResult(dataInit?._id, status)
    //     if (res.data) {
    //         message.success("Update Result status thành công!");
    //         setDataInit(null);
    //         onClose(false);
    //         reloadTable();
    //     } else {
